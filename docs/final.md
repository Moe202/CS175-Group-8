...
**Random Action:** <br>
Epsilon is the possibility of taking a random action instead of the best one.<br>
**Immediate Reward Value:** <br>r is the immediate reward value<br>
**Max Q Value:** <br>
The action has the highest utility value in next state will become the new Q value of that states<br>
...
#### Level 0:
<img src="images/level0gridf.png" title="grid" width="427" height="301" />
...
#### Level 1:
<img src="images/level1gridf.png" title="grid" width="426" height="297" />
...
#### Level 2:
<img src="images/level2gridf.png" title="grid" width="426" height="292" />
...
For each action the agent makes, there is a reward value of -1 for each move, -10 for each jump, -100 for reaching the lava block, +100 for reaching the redstone\_block(goal state)
#### Level 3:
<img src="images/level3gridf.png" title="grid" width="434" height="153" />
...
#### Level 4:
<img src="images/level4gridf.png" title="grid" width="400" height="400" />
...
<img src="images/level4gridfinal.png" title="level4grid" width="524" height="393" />
#### Reward for each actions
For each action the agent makes, there is a reward value of -1 for each move, -10 for each jump, -100 for reaching the lava block, +100 for reaching the redstone\_block(goal state)
