...
#### Level 0:
<img src="images/level0gridf.png" title="grid" width="400" height="400" />
...
#### Level 1:
<img src="images/level1gridf.png" title="grid" width="400" height="400" />
...
#### Level 2:
<img src="images/level2gridf.png" title="grid" width="400" height="400" />
...
For each action the agent makes, there is a reward value of -1 for each move, -10 for each jump, -100 for reaching the lava block, +100 for reaching the redstone\_block(goal state)
#### Level 3:
<img src="images/level3gridf.png" title="grid" width="400" height="400" />
